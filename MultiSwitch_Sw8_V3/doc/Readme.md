...
3. On the copper side, glue the 3-pin header with a 2.54 mm pitch (I used super glue). Leave the 3 pins of the header protruding 1.5 mm from the edge of the PCB.  
