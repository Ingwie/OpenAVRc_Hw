...
It is still possible to improve the quality of received messages by repeating the message several times. However, this causes the message to take longer to reach the receiver.  
