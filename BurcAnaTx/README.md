...
Some transmitters generate a CPPM signal, often used to connect to flight, drone, or other simulators.  
This signal can be used to optimize the quality of the message generated by the Rcul encoder.  
The CPPM signal can be either positive or negative. The encoder automatically supports both modes.  
```
