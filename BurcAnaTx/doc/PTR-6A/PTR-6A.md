...
In the case of the PTR-6A, the PPM signal is available only when the transmitter is used with a simulator; in this instance, the RF transmission is disabled.  
